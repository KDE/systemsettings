...
public:
    explicit SubcategoryModel(QAbstractItemModel *parentModel, IconsMode *parent = nullptr);
...
public:
    IconsMode(QObject *parent, const QVariantList &args);
    ~IconsMode() override;
